...
eu_avg_latency = df_eu['Latency max'].max()
us_avg_latency = df_us['Latency max'].max()
...
plt.title('Maximum Latency Comparison (EU vs US)')

plt.savefig('latency-max_comparison.png', dpi=300)
