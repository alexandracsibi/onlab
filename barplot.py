...
axs[0].set_xticklabels(['Indirect (EU)', 'Direct (US)'])
axs[0].set_xlabel('Methods')
axs[0].set_ylabel('Minimum Latency')
axs[0].set_title('Minimum Latency Comparison')
...
axs[1].set_xticklabels(['Indirect (EU)', 'Direct (US)'])
axs[1].set_xlabel('Methods')
axs[1].set_ylabel('Average Latency')
axs[1].set_title('Average Latency Comparison')
...
axs[2].set_xticklabels(['Indirect (EU)', 'Direct (US)'])
axs[2].set_xlabel('Methods')
axs[2].set_ylabel('Maximum Latency')
